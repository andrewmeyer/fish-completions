...
complete -f -c watson -n '__fish_watson_using_command report' -s p -l project -d "restrict to project"
complete -f -c watson -n '__fish_watson_using_command report' -s T -l tag -d "restrict to tag"
